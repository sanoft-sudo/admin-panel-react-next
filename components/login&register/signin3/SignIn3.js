...
const SignIn3 = () => {
    return (
        ...
        <form action="#" method="post">
          ...
          <input type="text" name="uname" id="uname" placeholder="Enter Username" className="input-box" />
          <br /><br />
          <label htmlFor="username">Password</label><br />
          <input type="password" name="uname" id="uname" placeholder="Enter Password" className="input-box" /><br />
