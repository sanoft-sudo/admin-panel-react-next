      ...
      <div className="chartBox">
        ...
        >
          <div className="col-sm-4 ">
            ...
            <div className="name-success textSize">Looks good!</div>
            <div className="name-error textSize">This is required field!</div>
            <div className="name-toShort textSize">Name to short!</div>
          </div>
          <div className="col-sm-4">
            ...
            <div className="email-success textSize">Looks good!</div>
            <div className="email-error textSize">Email is not valid!</div>
          </div>
          <div className="col-sm-4">
            <label htmlFor="validationCustom02" className="form-label">
              Phone
            ...
            <div className="phone-success textSize">Looks good!</div>
            <div className="phone-error textSize">
